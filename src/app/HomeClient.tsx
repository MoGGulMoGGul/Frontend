...
import { type PublicTipItem } from "@/lib/tips";
...
export default function HomeClient({ initial }: { initial: PublicTipItem[] }) {
          ...
          <main className="relative">
            <div className="relative overflow-x-clip">
              <HexGridWithData<PublicTipItem>
                items={initial} // 서버가 준 초기 데이터로 즉시 렌더
                externalLoading={false}
                fetcher={async () => []} // 추가 로딩 없으면 비워둠
